"""
Beecrowd - Identificando o Chá

Degustação de chá às escuras é a habilidade de identificar um chá
usando apenas seus sentidos do olfato e paladar.
...
Os participantes devem cheirar, saborear e avaliar a amostra, de modo a identificar o tipo
de chá, que pode ser: (1) o chá branco; (2) chá verde; (3) chá preto; ou (4) chá de ervas.
...
Saída
A saída contém um inteiro representando o número de concorrentes que obtiveram a
resposta correta.
"""

# entrada de dados
resposta_correta = int(input(""))
respostas_dos_competidores = input("").split()
contador_acertos = 0

# separando os dados
lista_respostas = [int(resposta) for resposta in respostas_dos_competidores]
