...
entre a desejada e a lida. Com esta diferença ela esvazia ou enche o pneu para chegar na
pressão correta.
...
Entrada
A primeira linha da entrada contém um inteiro N que indica a pressão desejada pelo motorista
(1 ≤ N ≤ 40). A segunda linha contém um inteiro M que indica a pressão lida pela
bomba (1 ≤ M ≤ 40).

Saída
Seu programa deve imprimir uma única linha, contendo a diferença entre a pressão desejada e
a pressão lida.
...
pressao_lida_pela_bomba = int(input(""))

# fazendo o cálculo
diferenca_de_pressoes = pressao_desejada - pressao_lida_pela_bomba

# printando resultado
print(diferenca_de_pressoes)
